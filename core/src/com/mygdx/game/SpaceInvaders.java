...
import com.mygdx.game.info.DialogBoxNewGame;
...
public class SpaceInvaders extends ApplicationAdapter {
    ...
    Music background;
    DialogBoxNewGame dialogBoxNewGame;
    ...
    public void create() {
        ...
        dialogBoxNewGame = new DialogBoxNewGame();
    ...
    public void render() {
        ...
        gameInfo.stage.draw();
        dialogBoxNewGame.dialogDraw();
        if (dialogBoxNewGame.isClicked()) {
            batch.begin();
            player.drow(batch);
    ...
    public void dispose() {
        batch.dispose();
        img.dispose();
        dialogBoxNewGame.dialogDispose();
    }
